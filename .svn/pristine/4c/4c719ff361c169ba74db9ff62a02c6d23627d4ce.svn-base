...
! function(e) {
	...
	var i = function(e) {
		...
		get : function(i, t, n) {
			...
			return n =
			void 0 === n ? !0 : n, null === s.content[t] ? "" : (Z(d) || Z(d.frameClass) || (p += " " + d.frameClass), r = s.template.replace(/\{previewId\}/g, c).replace(/\{frameClass\}/g, p).replace(/\{fileindex\}/g, o).replace(/\{content\}/g, s.content[t]).replace(/\{footer\}/g, a.footer(i, t, n)), s.tags.length && s.tags[t] && ( r = K(r, s.tags[t])), Z(d) || Z(d.frameAttr) || ( l = e(document.createElement("div")).html(r), l.find(".file-preview-initial").attr(d.frameAttr), r = l.html(), l.remove()), r)
		},
		...
		set : function(i, t, n, r, l) {
			...
			if (H(t) || ( t = t.split(s.delimiter)), l) {
				...
				s.content = t, s.config = n, s.tags = r;
			a.data[i] = s
		},
		unset : function(e, i) {
			var t = a.count(e);
		...
		footer : function(e, i, t) {
			var n = a.data[e];
			if ( t =
				void 0 === t ? !0 : t, 0 === n.config.length || Z(n.config[i]))
				return "";
		...
		image : function(e, i) {
			return
			void 0 !== e ? e.match("image.*") : i.match(/\.(gif|png|jpe?g)$/i)
		},
		html : function(e, i) {
			return
			void 0 !== e ? "text/html" === e : i.match(/\.(htm|html)$/i)
		},
		text : function(e, i) {
			return
			void 0 !== e && e.match("text.*") || i.match(/\.(txt|md|csv|nfo|ini|json|php|js|css)$/i)
		},
		video : function(e, i) {
			return
			void 0 !== e && e.match(/\.video\/(ogg|mp4|webm|3gp)$/i) || i.match(/\.(og?|mp4|webm|3gp)$/i)
		},
		audio : function(e, i) {
			return
			void 0 !== e && e.match(/\.audio\/(ogg|mp3|wav)$/i) || i.match(/\.(ogg|mp3|wav)$/i)
		},
		flash : function(e, i) {
			return
			void 0 !== e && "application/x-shockwave-flash" === e || i.match(/\.(swf)$/i)
		},
		object : function() {
			return !0
		},
		...
		return null === i ||
		void 0 === i || 0 === i.length || t && "" === e.trim(i)
	}, H = function(e) {
	...
	J.prototype = {
		...
		listen : function() {
			...
			t(a, "change", e.proxy(i.change, i)), t(r, "click", function() {
				...
				return i.isUploadable ? (t.preventDefault(),
				void (r && i.upload())) :
				void (r && "submit" !== n.attr("type") && ( a = n.closest("form"), a.length && a.trigger("submit"), t.preventDefault()))
			})
		},
		submitForm : function() {
		...
		abort : function(i) {
			var t, a = this;
			return a.ajaxAborted && "object" == typeof a.ajaxAborted &&
			void 0 !== a.ajaxAborted.message ? ( t = e.extend(a.getOutData(), i), t.abortData = a.ajaxAborted.data || {}, t.abortMessage = a.ajaxAborted.message, a.cancel(), a.setProgress(100), a.showUploadError(a.ajaxAborted.message, t, "filecustomerror"), !0) : !1
		},
		...
		upload : function() {
			...
			if (n.minFileCount > 0 && n.getFileCount(r) < n.minFileCount)
				return
				void  n.noFilesError(l);
		...
		initDragDrop : function() {
			...
			t(a, "dragenter.fileinput dragover.fileinput", function(t) {
				...
				return t.stopPropagation(), t.preventDefault(), i.isDisabled || !a ? (t.originalEvent.dataTransfer.effectAllowed = "none",
		...
		initFileActions : function() {
			...
			i.$preview.find(".kv-file-remove").each(function() {
				...
				t(l, "click", function() {
					return i.validateMinCount() ? (i.cleanMemory(o),
					void  o.fadeOut("slow", function() {
						i.filestack[s] =
						void 0, i.clearObjects(o), o.remove();
		...
		initPreview : function(e) {
			...
			return a.count(t.id) ? ( i = a.out(t.id), n = e && t.initialCaption ? t.initialCaption : i.caption, t.$preview.html(i.content), t.setCaption(n),
			void (Z(i.content) || t.$container.removeClass("file-input-new"))) : (t.clearPreview(),
			void ( e ? t.setCaption(n) : t.initCaption()))
		},
				...
				void 0 !== d) {
					...
					m = parseInt(m.replace("init_", "")), u = Z(g.config) && Z(g.config[m]) ? null : g.config[m], f = Z(u) || Z(u.extra) ? n : u.extra, "function" == typeof f && ( f = f()), p = {
						...
						success : function(e, t, n) {
							var o, s;
							return Z(e) || Z(e.error) ? (a.unset(i.id, m), o = a.count(i.id), s = o > 0 ? i.getMsgSelected(o) : "", i.raise("filedeleted", [d, n, f]), i.setCaption(s), v.removeClass("file-uploading").addClass("file-deleted"),
							void  v.fadeOut("slow", function() {
								i.clearObjects(v), v.remove(), r(), o || 0 !== i.getFileStack().length || (i.setCaption(""), i.reset())
							})) : (p.jqXHR = n, p.response = e, i.showError(e.error, p, "filedeleteerror"), v.removeClass("file-uploading"), l.removeClass("disabled"),
							void  r())
						},
		...
		cancel : function() {
			...
			t.getThumbs().each(function() {
				...
				void 0 !== t.filestack[a] && (i.find(".kv-file-upload").removeClass("disabled").removeAttr("disabled"), i.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")), t.unlock()
			})
		},
		...
		resetPreviewThumbs : function(e) {
			var i, t = this;
			return e ? (t.clearPreview(),
			void (t.filestack = [])) :
			void (t.hasInitialPreview() ? ( i = a.out(t.id), t.$preview.html(i.content), t.setCaption(i.caption), t.initPreviewDeletes()) : t.clearPreview())
		},
		reset : function() {
			var e = this;
		...
		initUploadSuccess : function(i, t, n) {
			...
			"object" != typeof i || e.isEmptyObject(i) ||
			void 0 !== i.initialPreview && i.initialPreview.length > 0 && (u.hasInitData = !0, d = i.initialPreview || [], c = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], r =
			void 0 === i.append || i.append ? !0 : !1, u.overwriteInitial = !1,
			void 0 === t || n ? n ? (u.uploadCache.content.push(d[0]), u.uploadCache.config.push(c[0]), u.uploadCache.tags.push(p[0]), u.uploadCache.append = r) : (a.set(u.id, d, c, p, r), u.initPreview(), u.initPreviewDeletes()) : ( o = a.add(u.id, d, c[0], p[0], r), l = a.get(u.id, o, !1), s = e(l).hide(), t.after(s).fadeOut("slow", function() {
		...
		uploadSingle : function(i, t, n) {
			...
			g.formdata = h, 0 === m || !y || C.hasClass("disabled") || g.abort(T) || ( o = function() {
				...
				r = g.getOutData(l, t), T = e.extend(T, r), setTimeout(function() {
					Z(t) || Z(t.error) ? (g.setThumbStatus(b, "Success"), C.hide(), g.filestack[i] =
					void 0, g.raise("fileuploaded", [r, w, i]), g.initUploadSuccess(t, b, n), n || g.resetFileStack()) : (g.setThumbStatus(b, "Error"), g.showUploadError(t.error, T))
				}, 100)
			}, f = function() {
				setTimeout(function() {
		...
		uploadBatch : function() {
			...
			l.formdata = new FormData, 0 !== d && p && !l.abort(c) && ( i = function() {
				...
				var r = l.getOutData(n, t), o = l.getThumbs(), s = Z(t.errorkeys) ? [] : t.errorkeys, d = 0;
				Z(t) || Z(t.error) ? (l.raise("filebatchuploadsuccess", [r]), i(), l.showPreview ? (o.each(function() {
					...
					return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === s.length ?
					void  l.setThumbStatus(i, "Error") : (-1 !== e.inArray(d, s) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.filestack[d] =
					void 0),
					void d++)
		...
		parseFileType : function(e) {
			...
			for ( n = 0; n < M.length; n += 1)
				if ( a = M[n], i = W(a, r.fileTypeSettings) ? r.fileTypeSettings[a] : N[a], t = i(e.type, e.name) ? a : "", !Z(t))
					return t;
			return "other"
		},
		...
		readFiles : function(i) {
			function t(e) {
				if (Z(n.attr("multiple")) && ( u = 1), e >= u)
					return a.isUploadable && a.filestack.length > 0 ? a.raise("filebatchselected", [a.getFileStack()]) : a.raise("filebatchselected", [i]), o.removeClass("loading"),
					void  s.html("");
				...
				if (Z(U) || ( $ = new RegExp("\\.(" + U.join("|") + ")$", "i")), k = k.toFixed(2), a.maxFileSize > 0 && k > a.maxFileSize)
					return b = a.msgSizeTooLarge.replace("{name}", E).replace("{size}", k).replace("{maxSize}", a.maxFileSize),
					void (a.isError = g(b, F, T, e));
				if (!Z(P) && H(P)) {
					for ( w = 0; w < P.length; w += 1)
						C = P[w], h = f[C], x =
						void 0 !== h && h(F.type, E), S += Z(x) ? 0 : x.length;
					if (0 === S)
						return b = a.msgInvalidFileType.replace("{name}", E).replace("{types}", D),
						void (a.isError = g(b, F, T, e))
				}
				return 0 !== S || Z(U) || !H(U) || Z($) || ( x = E.match($), S += Z(x) ? 0 : x.length, 0 !== S) ? a.showPreview ? (r.length > 0 &&
				void 0 !== FileReader ? (s.html(d.replace("{index}", e + 1).replace("{files}", u)), o.addClass("loading"), l.onerror = function(e) {
					a.errorHandler(e, E)
				}, l.onload = function(i) {
				...
				void  a.filestack.push(F)) : (a.filestack.push(F), setTimeout(t(e + 1), 100),
				void  a.raise("fileloaded", [F, T, e, l])) : ( b = a.msgInvalidFileExtension.replace("{name}", E).replace("{extensions}", j),
				void (a.isError = g(b, F, T, e)))
			}
		...
		change : function(i) {
			...
			if (!t.isUploadable && Z(n.val()) && t.fileInputCleared)
				return
				void (t.fileInputCleared = !1);
			...
			if (t.reader = null, t.resetUpload(), t.hideFileIcon(), t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(), p)
				for ( r = []; u[v]; )
					s = u[v], s.type || s.size % 4096 !== 0 ? r.push(s) : g++, v++;
			else
				r =
				void 0 === i.target.files ? i.target && i.target.value ? [{
					name : i.target.value.replace(/^.+\\/, "")
				}] : [] : i.target.files;
			if (Z(r) || 0 === r.length)
				return h || t.clear(), t.showFolderError(g),
			...
			if (t.resetErrors(), c = r.length, o = t.isUploadable ? t.getFileStack().length + c : c, o = t.getFileCount(o), t.maxFileCount > 0 && o > t.maxFileCount) {
				if (!t.autoReplace || c > t.maxFileCount)
					return d = t.autoReplace && c > t.maxFileCount ? c : o, l = t.msgFilesTooMany.replace("{m}", t.maxFileCount).replace("{n}", d), t.isError = b(l, null, null, null), t.$captionContainer.find(".kv-caption-icon").hide(), t.setCaption("", !0),
					void  t.$container.removeClass("file-input-new file-input-ajax-new");
				o > t.maxFileCount && t.resetPreviewThumbs(h)
			} else
				!h || w ? (t.resetPreviewThumbs(!1), w && (t.filestack = [])) : !h || 0 !== m || a.count(t.id) && !t.overwriteInitial || t.resetPreviewThumbs(!0);
...
(function(t, i, n, e) {
	"use strict";
	var r, o, s, a, l, h, c, p, u, d, f, A, m, w, g, y, b, v, x, C, S, E, M, k, H, D, F, T = [].indexOf ||
	function(t) {
	...
	S = "notify", C = S + "js", s = S + "!blank", M = {
		...
		return (null != ( a = D[i]) ? a.cssElem :
		void 0) && (t.console && console.warn("" + S + ": overwriting style '" + i + "'"), D[i].cssElem.remove()), e.name = i, D[i] = e, r = "", e.classes && n.each(e.classes, function(t, i) {
		...
		if ("string" == typeof n)
			...
			return;
		if (!isNaN(n))
			return r = M[v[i.charAt(0)]], o = i, t[r] !== e && ( i = M[r.charAt(0)], n = -n), t[i] === e ? t[i] = n : t[i] += n, null
	}, k = function(t, i, n) {
		if ("l" === t || "t" === t)
			return 0;
		if ("c" === t || "m" === t)
		...
		return t.prototype.loadHTML = function() {
			...
			if ( r = function() {
				...
				}, a = this.container.parent().parents(":hidden").length > 0, o = this.container.add(this.arrow), n = [], a && t)
				s = "show";
			else if (a && !t)
				s = "hide";
			else if (!a && t)
		...
		return y(a.css).attr("id", "core-notify"), n(i).on("click", "." + C + "-hidable", function() {
			...
			var t;
			return null != ( t = n(this).data(C)) ? t.show(!1) :
			void 0
		})
	})
